...
function Phone({ children, bg="#f7f9f6" }) {
  return (
    <div style={{
      minHeight:"100vh",
      background:"linear-gradient(145deg,#c8dfd8 0%,#d8e8c8 40%,#d4cce8 100%)",
      display:"flex", justifyContent:"center", alignItems:"flex-start",
      padding:"20px 12px",
      fontFamily:"'Nunito','DM Sans',system-ui,sans-serif",
    }}>
      <div style={{
        width:390, minHeight:800,
        background:bg, borderRadius:50,
        boxShadow:"0 32px 80px rgba(60,80,60,0.18),0 2px 0 rgba(255,255,255,0.8) inset",
        overflow:"hidden", display:"flex", flexDirection:"column",
        position:"relative", border:"1.5px solid rgba(255,255,255,0.6)",
      }}>
        <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",
          padding:"14px 26px 0",fontSize:13,fontWeight:700,color:"#2d3a2d",flexShrink:0}}>
          <span>21:12</span>
          <div style={{width:22,height:6,background:"#2d3a2d",borderRadius:3}}/>
...
function BottomBar({ screen, onAdd, onMain, onCal }) {
  return (
    <div style={{
...
export default function App() {
  ...
  async function addReminder() {
    ...
    setSaving(true);
    try {
      const { data } = await supabase.from("loculus_reminders").insert({
  ...
  if (screen==="catEdit") return (
    <Phone bg="#f7f9f6">
        ...
        <div style={{padding:"14px 16px",borderRadius:16,marginTop:8,
          ...
          <div style={{display:"flex",gap:8,alignItems:"center"}}>
            <input placeholder="Nome" value={newCatLabel} onChange={e=>setNewCatLabel(e.target.value)}
              style={{flex:1,border:"1px solid #ddd",borderRadius:10,padding:"8px 12px",fontSize:14}}/>
      ...
      <BottomBar screen="catEdit" onAdd={()=>{setScreen("main");setShowAdd(true);}}
        onMain={()=>setScreen("main")} onCal={()=>setScreen("calendar")}/>
    </Phone>
  );
    ...
    return (
      <Phone bg="#f7f9f6">
        ...
        <BottomBar screen="calendar" onAdd={()=>setShowAdd(true)}
          onMain={()=>{setScreen("main");setCalOffset(0);}} onCal={()=>{}}/>
      </Phone>
    );
  }
  ...
  return (
    <Phone bg="#f7f9f6">
      ...
      <BottomBar screen="main" onAdd={()=>setShowAdd(true)}
        onMain={()=>{}} onCal={()=>setScreen("calendar")}/>
    </Phone>
  );
}
