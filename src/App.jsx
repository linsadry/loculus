...
const supabase = createClient(
  ...
  'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InVuamJkY2pjZnFteXRhcHh5dnVmIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDU3ODUzNDAsImV4cCI6MjA2MTM2MTM0MH0.j4VQfPNvAyMOkN7F3eiGSBzSV-WBzZ_XRhNjOY8bT_E'
);
    ...
    <Screen bg="linear-gradient(180deg,#e8f4ef 0%,#f0ede8 60%,#e8e4f0 100%)">
      <div style={{flex:1, display:"flex", flexDirection:"column",
        ...
        {loading ? (
          ...
          <PinPad
            value={first} onChange={setFirst}
            onSubmit={handleFirst} error={error}
            label="Crie seu PIN"
            sublabel="6 dígitos para proteger suas gavetas"
          />
        ) : (
          <PinPad
            value={second} onChange={setSecond}
            onSubmit={handleConfirm} error={error}
            label="Confirme o PIN"
            sublabel="Digite novamente para confirmar"
          />
        )}
      </div>
    </Screen>
...
export default function App() {
  ...
  useEffect(() => {
    async function checkAuth() {
      ...
      if (sessionStorage.getItem("loculus_auth") === "1") {
        setAuthState("ok");
        return;
      }
